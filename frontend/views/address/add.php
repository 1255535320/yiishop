...
<!--                    --><?//=var_dump($model1);exit;?>
                    <tr>
                        <td><?= $model1['name'] ?></td>
                        <td><?= $model1['phone'] ?></td>
                        <td><?= $model1['province'] ?></td>
                        <td><?= $model1['city'] ?></td>
                        <td><?= $model1['area'] ?></td>
                        <td><?= $model1['address'] ?></td>
                        <td>
                            <?= yii\bootstrap\Html::a('删除', ['/address/delete', 'id' => $model1['id']], ['class' => 'btn btn-info']) ?>
                            <?= yii\bootstrap\Html::a('修改', ['/address/update', 'id' => $model1['id']], ['class' => 'btn btn-info']) ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </table>
        ...
        <div class="user_bd mt10">
            <form action="<?= \yii\helpers\Url::to('/address/add') ?>" method="post">
                ...
                <ul>
                    <li>
                        <label for="">收货人：</label>
                        <strong><input type="text" name="name" id="name"/></strong>
                    </li>
                    <li>
                        <label for="">手机号码：</label>
                        <strong><input type="text" name="phone" id="phone"/></strong>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <strong><input type="text" name="address" id="address"/></strong>
                    </li>
                    <li>
                        <label for="">&nbsp;</label>
