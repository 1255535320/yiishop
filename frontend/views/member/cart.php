	...
	<div class="mycart w990 mt10 bc">
		...
		<table>
            ...
            <?php foreach ($models as $model):?>
                ...
                <tr data-id="<?=$model->id?>">
					<td class="col1"><a href=""><img src="<?=Yii::$app->params['backend_domain'].$model->logo?>" alt="" />
                        </a><strong><a href=""><?=$model->name?></a></strong></td>
					...
					<td class="col6"><a href="<?=\yii\helpers\Url::to(['member/cart-del','goods_id'=>$model->id])?>">删除</a></td>
				</tr>
            <?php endforeach;?>
            </tbody>
			<tfoot>
