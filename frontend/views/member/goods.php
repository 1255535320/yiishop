		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="<?=Yii::$app->params['backend_domain'].$model->logo?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?=Yii::$app->params['backend_domain'].$model->logo?>" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
                                <?php foreach ($img as $k=>$img1):?>
								<li class="<?=($k==0?'cur':'')?>">
									<a class="<?=($k==0?'zoomThumbActive':'')?>" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'images/preview_m1.jpg',largeimage: 'images/preview_l1.jpg'}">
                                        <img src="<?=Yii::$app->params['backend_domain'].$img1->path?>"></a>
								</li>
                                <?php endforeach;?>
							</ul>
						</div>
				...
				<div class="goodsinfo fl ml10">
					...
					<form action="<?=\yii\helpers\Url::to(['member/add-cart'])?>" method="get" class="choose">
						<ul>
							<li>
								<dl>
									<dt>购买数量：</dt>
